...
def test_message_serializer(
    binary_messages: List[Message], string_messages: List[Message], string_serializer: StringSerializer
):
...
def test_message_serializer_many(
    ...
    serialized_messages: List[Message] = list(serializer.serialize_many(string_messages))
